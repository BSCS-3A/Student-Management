    ...
    var O = function (g) {
        ...
        function Ea(a, b) {
            var c = p.defaults.column,
                ...
                c = g.extend({}, p.models.oColumn, c, { nTh: b ? b : P.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [e], mData: c.mData ? c.mData : e, idx: e });
            a.aoColumns.push(c);
            c = a.aoPreSearchCols;
        ...
        function Ga(a) {
            ...
            for (f = b.length; d < f; d++)
                if (((m = b[d]), (k = []), !m.sType && m._sManualType)) m.sType = m._sManualType;
                else if (!m.sType) {
                    h = 0;
            ...
            if (-1 !== g.inArray(!1, b)) B(a, !1);
                ...
                if (0 !== j.length) {
                    ...
                    (c = f.sZeroRecords),
                        ...
                        (b[0] = g("<tr/>", { class: d ? e[0] : "" }).append(g("<td />", { valign: "top", colSpan: aa(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
        ...
        function sb(a) {
            ...
            for (h = 0; h < c; h++)
                (n = b[h]),
                    ...
                    l.columns.push({ data: j, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: m.sSearch, regex: m.bRegex } }),
                    k("mDataProp_" + h, j),
        ...
        function nb(a) {
            var b = a.oClasses,
                ...
                j = g("input", b)
                    ...
                    .bind("keyup.DT search.DT input.DT paste.DT cut.DT", h ? ta(f, h) : f)
        ...
        function Bb(a, b) {
            ...
            return b
                ...
                .replace(/_PAGE_/g, c.call(a, h ? 1 : Math.ceil(e / d)))
                .replace(/_PAGES_/g, c.call(a, h ? 1 : Math.ceil(f / d)));
        }
        function ga(a) {
            var b,
                c,
        ...
        function mb(a) {
            for (
                var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, d = g.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e, d = g("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), h = 0, i = f.length;
                h < i;
                h++
            )
        ...
        function Sa(a, b, c) {
            ...
            0 === f || -1 === d
                ...
                : R(a, 0, "Unknown paging action: " + b, 5);
        ...
        function Gb() {
            if (!p.__scrollbarWidth) {
                var a = g("<p/>").css({ width: "100%", height: 200, padding: 0 })[0],
                    b = g("<div/>").css({ position: "absolute", top: 0, left: 0, width: 200, height: 150, padding: 0, overflow: "hidden", visibility: "hidden" }).append(a).appendTo("body"),
                    c = a.offsetWidth;
        ...
        function Ib(a) {
            for (var b, c, e = a.aoColumns, d = T(a), a = a.oLanguage.oAria, f = 0, h = e.length; f < h; f++) {
                ...
                c.bSortable &&
                    (0 < d.length && d[0].col == f ? (j.setAttribute("aria-sort", "asc" == d[0].dir ? "ascending" : "descending"), (c = g[d[0].index + 1] || g[0])) : (c = g[0]), (b += "asc" === c ? a.sSortAscending : a.sSortDescending));
        ...
        function Ta(a, b, c, e) {
            ...
            c && a.oFeatures.bSortMulti
                ? ((c = g.inArray(b, C(d, "0"))), -1 !== c ? ((b = h(d[c], !0)), null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b))) : (d.push([b, f[0], 0]), (d[d.length - 1]._idx = 0)))
                : d.length && d[0][0] == b
                ? ((b = h(d[0])), (d.length = 1), (d[0][1] = f[b]), (d[0]._idx = b))
        ...
        function u(a, b, c, e) {
            var d = [];
            b &&
                (d = g.map(a[b].slice().reverse(), function (b) {
        ...
        function Va(a, b) {
            ...
            b <= c
                ? (c = U(0, b))
                : a <= e
                ? ((c = U(0, c - 2)), c.push("ellipsis"), c.push(b - 1))
                : (a >= b - 1 - e ? (c = U(b - (c - 2), b)) : ((c = U(a - 1, a + 2)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
            c.DT_el = "span";
            return c;
        }
        function cb(a) {
        ...
        p = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    j = k.oClasses;
                    d.bJQueryUI
                        ? (g.extend(j, p.ext.oJUIClasses, d.oClasses), d.sDom === m.sDom && "lfrtip" === m.sDom && (k.sDom = '<"H"lfr>t<"F"ip>'), k.renderer)
                            ? g.isPlainObject(k.renderer) && !k.renderer.header && (k.renderer.header = "jqueryui")
                            : (k.renderer = "jqueryui")
                        : g.extend(j, p.ext.classes, d.oClasses);
                    ...
                    if (q.length) {
                        ...
                        g.each(ma(k, q[0]).cells, function (a, b) {
                            ...
                            if (c.mData === a) {
                                ...
                                if (e !== null || d !== null) {
                                    c.mData = { _: a + ".display", sort: e !== null ? a + ".@data-" + e : l, type: e !== null ? a + ".@data-" + e : l, filter: d !== null ? a + ".@data-" + d : l };
                                    ja(k, a);
                                }
                            }
                        });
        ...
        q.register = r = function (a, b) {
            if (g.isArray(a)) for (var c = 0, e = a.length; c < e; c++) q.register(a[c], b);
                ...
                for (var d = a.split("."), f = Sb, h, i, c = 0, e = d.length; c < e; c++) {
        ...
        t("columns().search()", "column().search()", function (a, b, c, e) {
            return this.iterator("column", function (d, f) {
                ...
                d.oFeatures.bFilter && (g.extend(h[f], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === e ? !0 : e }), fa(d, d.oPreviousSearch, 1));
            });
        });
        r("state()", function () {
        ...
        r("destroy()", function (a) {
            ...
            return this.iterator("table", function (b) {
                ...
                b.bJUI &&
                    (g("th span." + e.sSortIcon + ", td span." + e.sSortIcon, h).detach(),
        ...
        g.extend(w, { afnFiltering: w.search, aTypes: w.type.detect, ofnSearch: w.type.search, oSort: w.type.order, afnSortData: w.order, aoFeatures: w.feature, oApi: w.internal, oStdClasses: w.classes, oPagination: w.pager });
                        ...
                        o = function (b, e) {
                            ...
                            for (p = e.length; k < p; k++) {
                                ...
                                if (g.isArray(q)) {
                                    ...
                                    if (j) {
                                        r = g("<a>", { class: h.sPageButton + " " + l, "aria-controls": a.sTableId, "data-dt-idx": m, tabindex: a.iTabIndex, id: c === 0 && typeof q === "string" ? a.sTableId + "_" + q : null })
                                            .html(j)
                                            .appendTo(b);
                                        Ua(r, { action: q }, s);
                                        m++;
            ...
            header: {
                ...
                jqueryui: function (a, b, c, e) {
                    g("<div/>")
                        ...
                        .append(b.contents())
                        .append(g("<span/>").addClass(e.sSortIcon + " " + c.sSortingClassJUI))
                        .appendTo(b);
                    g(a.nTable).on("order.dt.DT", function (d, f, g, i) {
                        if (a === f) {
                            ...
                            b.find("span." + e.sSortIcon)
                                ...
                                .addClass(i[d] == "asc" ? e.sSortJUIAsc : i[d] == "desc" ? e.sSortJUIDesc : c.sSortingClassJUI);
                        }
                    });
                },
            },
