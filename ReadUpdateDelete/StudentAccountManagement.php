      ...
      <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="form-group">              
                    <input class="form-control " name="Mname" id="Mname" type="text" placeholder="Enter Middle Name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">  
                    <input class="form-control " name="bumail" id="bumail" type="text" placeholder="Enter Email" required>              
                 </div>
            </div>
                <div class="modal-footer ">
