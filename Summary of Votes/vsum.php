...
<body>
    ...
    <div class="container">
       <section> <form method="get" action="file.doc">
        <button class="btn btn-button1" type="submit" data-placement="top" data-toggle="tooltip" title="Print Vote Summary"><span class="fa fa-print"></span> PRINT SUMMARY</button>
     ...
     <div class="table-responsive">            
      <table class= "center" id="datatable" width="100%" cellspacing="0" cellpadding="0">
                          ...
                          <?php
	    	                ...
	    	                if($row['fname']!=$name && $flag == 0){?>
		                    <tr><td><?php echo $row['fname']?></td><?php
		                    $flag = 1;
		                    $name=$row['fname'];
