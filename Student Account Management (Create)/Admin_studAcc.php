                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input class="form-control " name="Add_ID" type="text" placeholder="Enter Student ID" required="required">
                        </div>
                        <div class="form-group">
                            <input class="form-control " name="lname" type="text" placeholder="Enter Last Name" required="required">
                        </div>
                        <div class="form-group">
                            <input class="form-control " name="fname" type="text" placeholder="Enter First Name" required="required">
                        </div>
                        <div class="form-group"> <!-- Do not require, not all students have middle name -->
                            <input class="form-control " name="Mname" type="text" placeholder="Enter Middle Name">
                        </div>
                        <div class="form-group">
                            <input class="form-control " name="gender" ype="text" placeholder="Enter Gender" required="required">
                        </div>
                        <div class="form-group">
                            <input class="form-control " name="bumail" type="text" placeholder="Enter Email" required="required">
                        </div>
                        <div class="form-group">
                            <input class="form-control " name="grade_level" type="text" placeholder="Enter Grade Level" required="required">
                        </div>
                    </div>
                    <div class="modal-footer ">
                        <button type="submit" name="add" class="btn btn-warning btn-lg" id = "save" style="width: 100%;"><span class="fa fa-check-circle"></span> Add</button>
